...
export const useSettings = () => {
    ...
    const settings = async (email, password, nickname, theme) => {
        ...
        const response = await fetch('https://budgetbuddytest-backend.onrender.com/user/settings', {
            method: 'PUT',
            headers: {
    ...
    const deleteAccount = async (password) => {
        ...
        const response = await fetch('https://budgetbuddytest-backend.onrender.com/user/delete', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
